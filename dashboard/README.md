...
### Mock Data
- `containers`: Array of container objects with security configurations
- `driftEvents`: Array of security drift events
- `securityRules`: Array of active security rules
- `pipelineStatus`: Current status of the security pipeline
